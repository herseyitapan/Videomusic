...
def song(_, message):
    ...
    try:
        ...
        m.edit("❌ Xəta dəstək qrupumuza gəlin")
        print(e)
...
@Client.on_message(command(["vyukle", f"vyukle@{bn}", "vyukle", f"vyukle@{bn}"]) & ~filters.edited)
